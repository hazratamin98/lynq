  ...
  return (
    ...
    <div className='  flex-col text-center space-y-6 '>
      <h1 className='font-bold md:text-[55px] text-[38px] md:leading-[66px] leading-[38px] center mt-40 inline-block text-[#FFFFFF]' >
       ...
       <span  className=" relative before:block before:absolute before:inset-5 md:before:mt-6 before:py-4 md:visible hidden   before:bg-[#5A27E7]">
    ...
    <div   className='  '  > <Image src={Mouckupp} alt="Mouckupp"/></div>
      ...
      <div className='  flex-col text-center space-y-6 '>
      <h1 className='font-bold md:text-[55px] text-[22px] md:leading-[66px] leading-[30px]  text-[#FFFFFF]' >
     Selling expertise and interaction with your <br/> audience is
      <span  className=" relative before:block before:absolute md:visible hidden before:inset-5 before:mt-4 before:py-4    before:bg-[#5A27E7]">
    <span className="relative text-white">  your next big source of revenue</span>
  </span>
     
      </h1>
      <p className='md:font-medium font-normal  md:text-lg text-base text-[#999CA0] leading-[22px] '>Let Lynq helps you launch your own expertise video channel</p>
